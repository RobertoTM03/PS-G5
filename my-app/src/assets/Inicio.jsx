        ...
        <div className="inicio">
            <div className="container">
                <div className="left-section">
                    ...
                    <p>Facilita la colaboración en equipo con herramientas para organizar grupos, dividir gastos, gestionar eventos, compartir documentos y comunicarte en tiempo real.</p>
